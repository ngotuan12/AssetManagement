...
class Reason(models.Model):
    ...
    code = models.CharField(max_length=10,db_column="reason_code")
    name = models.CharField(max_length=200,db_column="reason_name")
    status = models.CharField(max_length=1,default='0',db_column="reason_status")
