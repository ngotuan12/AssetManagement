-- Start of DDL Script for Package ASSET.PCK_REPORT
-- Generated 8-Sep-2014 0:42:16 from ASSET@ORCL

-- Start of DDL Script for Type ASSET.T_REPORT_ASSET_ROW
-- Generated 8-Sep-2014 0:48:23 from ASSET@ORCL
...
TYPE t_report_asset_row AS OBJECT
    ...
    (
     ...
     cur_level number(4),
     max_level number(4),
     flag_in_stock number(1))
/



-- End of DDL Script for Type ASSET.T_REPORT_ASSET_ROW

-- Start of DDL Script for Type ASSET.T_REPORT_ASSET_SUM_ROW
-- Generated 8-Sep-2014 0:48:23 from ASSET@ORCL
...
-- End of DDL Script for Type ASSET.T_REPORT_ASSET_SUM_ROW

-- Start of DDL Script for Type ASSET.T_REPORT_ASSET_SUM_TAB
-- Generated 8-Sep-2014 0:48:23 from ASSET@ORCL
...
-- End of DDL Script for Type ASSET.T_REPORT_ASSET_SUM_TAB

-- Start of DDL Script for Type ASSET.T_REPORT_ASSET_TAB
-- Generated 8-Sep-2014 0:48:23 from ASSET@ORCL
...
-- End of DDL Script for Type ASSET.T_REPORT_ASSET_TAB
    ...
    LOOP
       ...
       loop
          ...
          if(v_cur_row_num=0) THEN
              ...
              l_tab.extend;
              v_row_num:=v_row_num+1;
              dbms_output.put_line('loop from '||(1)||'to '||(i));
              for m in 1..i
              loop
                dbms_output.put_line('previous'||l_tab(l_tab.count-m).asset_name);
    ...
    LOOP
       ...
       loop
          ...
          if(v_cur_row_num=0) THEN
            ...
            --  l_tab(l_tab.last):=l_tab(l_tab.last-1);
              l_tab(l_tab.count-i):=t_report_asset_sum_row(v_row_num,null,v_cur_parent_id,
                                                     v_parent_id,
                                                     v_parent_name,
                                                     v_parent_code,
                                                     null,
...
-- End of DDL Script for Package ASSET.PCK_REPORT
